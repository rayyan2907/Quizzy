...
CREATE TABLE `attempt` (
  ...
  `atemptID` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`atemptID`),
  KEY `quizID` (`quizID`),
  KEY `subjectID` (`subjectID`),
  KEY `studentID` (`studentID`),
  CONSTRAINT `attempt_ibfk_1` FOREIGN KEY (`quizID`) REFERENCES `quiz` (`quizID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `attempt_ibfk_2` FOREIGN KEY (`subjectID`) REFERENCES `subjects` (`subjectID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `attempt_ibfk_3` FOREIGN KEY (`studentID`) REFERENCES `subjects` (`subjectID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `enrollments` (
  ...
  KEY `subject_id_key` (`subjectID`),
  KEY `student_id_key` (`studentID`),
  CONSTRAINT `student_id_key` FOREIGN KEY (`studentID`) REFERENCES `students` (`studentId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `subject_id_key` FOREIGN KEY (`subjectID`) REFERENCES `subjects` (`subjectID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `mcqs` (
  ...
  PRIMARY KEY (`mcqID`),
  KEY `quiz_key` (`quizID`),
  CONSTRAINT `quiz_key` FOREIGN KEY (`quizID`) REFERENCES `quiz` (`quizID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `quiz` (
  ...
  `subjectID` int DEFAULT NULL,
  `is_asssign` tinyint(1) DEFAULT NULL,
  `attempt` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`quizID`),
  KEY `sub_key` (`subjectID`),
  CONSTRAINT `sub_key` FOREIGN KEY (`subjectID`) REFERENCES `subjects` (`subjectID`)
...
CREATE TABLE `results` (
  ...
  KEY `quiz_key_2` (`quizID`),
  KEY `student_key_2` (`studentID`),
  CONSTRAINT `quiz_key_2` FOREIGN KEY (`quizID`) REFERENCES `quiz` (`quizID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `student_key_2` FOREIGN KEY (`studentID`) REFERENCES `students` (`studentId`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `short_questions` (
  ...
  PRIMARY KEY (`shqID`),
  KEY `shq_key` (`quizID`),
  CONSTRAINT `shq_key` FOREIGN KEY (`quizID`) REFERENCES `quiz` (`quizID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-05-03 14:21:52
